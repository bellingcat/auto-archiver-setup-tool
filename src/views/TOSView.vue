<template>
  <v-container class="pane">
    ...
    <p>
      ...
      <a href="https://auto-archiver.bellingcat.com"
        >https://auto-archiver.bellingcat.com</a
      >
    ...
    <p>
      ...
      any other services provided by Bellingcat.
    </p>
    <p>
    ...
    <p>These Terms of Service were last updated on 21 May 2025.</p>
    ...
    <p>
      ...
      restrictions or the Terms of Service, and may be terminated by Bellingcat
      at any time.
    </p>
    ...
    <p>
      ...
      website, even if Bellingcat or an authorised representative has been
    ...
    <p>
      ...
      general information purposes only. Bellingcat does not warrant or make any
    ...
    <h3>Links</h3>
    <p>
      Bellingcat has not reviewed all of the sites linked to its website and is
      not responsible for the contents of any such linked site. The inclusion of
      any link does not imply endorsement, approval or control by Bellingcat of
    ...
    <p>
      ...
      (collectively referred to as the &ldquo;Products&rdquo;) provided by
      Bellingcat under any ongoing agreement. It’s designed to protect us, our
      customers and the general Internet community from unethical, irresponsible
    ...
    <p>
      ...
      on an unauthorised basis as a result of the customer’s failure to put in
    ...
    <p>
      ...
      appropriate without notice. To the extent permitted by law, no credit will
      be available for interruptions of service resulting from any violation of
    ...
    <p>
      Our Products must not be used for the purpose of advertising, transmitting
      or otherwise making available any software, program, product or service
      designed to violate this acceptable use policy, or the acceptable use
      policy of other service providers. This includes but isn’t limited to
      facilitating the means to send spam and the initiation of network
    ...
    <p>
      ...
      not authorised to access the resource (e.g. &ldquo;hacking&rdquo;,
    ...
    <p>
      ...
      Bellingcat property (including our Products and brand) for the purpose of
